#import tkinter for GUI and tkk for improved widgets
...
class RestaurantOrderManagement:
    ...
    def __init__(self, root):
        ...
        self.exchange_rate = 0.74 #exchange rate for currrency conversion
        ...
        self.menu_labels = {}   #to store refrences to men item labels
        self.menu_quantities = {}   #to store refrences to quantity entry widgets
        ...
        currency_dropdown.current(0) #set default currenncy
    ...
    #methos=d to update menu price based on selected currency
    def update_menu_prices(self, *args):
        currency = self.currency_var.get()
        symbol = "£" if currency == "GBP" else "$"
        rate = self.exchange_rate if currency == "GBP" else 1
